...
using tibs.stem.Url;
using tibs.stem.Web.Public.Startup;
using tibs.stem.Web.Session;

namespace tibs.stem.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : stemViewComponent
    {
