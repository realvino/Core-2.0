...
namespace tibs.stem.Web.Public.Startup
{
    ...
    public class stemWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public stemWebFrontEndModule(IHostingEnvironment env, stemEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(stemWebFrontEndModule).GetAssembly());
        }
    }
}
