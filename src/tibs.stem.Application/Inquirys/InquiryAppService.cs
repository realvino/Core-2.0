...
namespace tibs.stem.Inquirys
{
    public class InquiryAppService : stemAppServiceBase, IInquiryAppService
    {
        ...
        //                 join enqDetail in _enquiryDetailRepository.GetAll() on enq.Id equals enqDetail.InquiryId
        //                 join usr in UserManager.Users on enqDetail.AssignedbyId equals usr.Id
        //                 where enq.MileStoneId > 3 && enq.Junk == null && enq.Won != true && enqDetail.AssignedbyId == userid
        //                 select enq
        //                );
        //    }
        ...
        //                 join team in _TeamRepository.GetAll() on enqDetail.TeamId equals team.Id
        //                 join usr in UserManager.Users on team.SalesManagerId equals usr.Id
        //                 where enq.MileStoneId > 3 && enq.Junk == null && enq.Won != true && team.SalesManagerId == userid
        //                 select enq
        //                );
        //    }
        //    else if (userrole.DisplayName == "Designer")
        ...
        //        query = (from enq in _inquiryRepository.GetAll()
        //                 join leadDetail in _LeadDetailRepository.GetAll() on enq.Id equals leadDetail.InquiryId
        //                 where enq.MileStoneId > 3 && enq.Junk == null && enq.Won != true && leadDetail.DesignerId == userid
        //                 select enq
        //                );
        //    }
        //    else if (userrole.DisplayName == "Sales Coordinator")
        ...
        //        query = (from enq in _inquiryRepository.GetAll()
        //                 join leadDetail in _LeadDetailRepository.GetAll() on enq.Id equals leadDetail.InquiryId
        //                 where enq.MileStoneId > 3 && enq.Junk == null && enq.Won != true && leadDetail.CoordinatorId == userid
        //                 select enq
        //                );
        //    }
        //    else
        //    {
        //        query = _inquiryRepository.GetAll().Where(p => p.MileStoneId > 3 && p.Junk != true && p.Won != true);
        //    }
        ...
        //                        join pr in UserManager.Users on enqDetail.AssignedbyId equals pr.Id into prJoined
        //                        from pr in prJoined.DefaultIfEmpty()
        //                        where a.IsClosed != true && a.Archieved != true
        //                        select new InquiryListDto
        //                        {
        //                            Id = a.Id,
        //                            MileStoneId = a.MileStoneId,
        ...
        //                            Name = a.Name,
        //                            Address = a.Locations.LocationName,
        //                            WebSite = a.WebSite,
        //                            Email = a.Email,
        //                            MbNo = a.MbNo,
        //                            Remarks = a.Remarks,
        ...
        //                            IpAddress = a.IpAddress,
        //                            Browcerinfo = a.Browcerinfo,
        //                            CreatorUserId = a.LastModifierUserId != null ? (int)a.LastModifierUserId : (int)a.CreatorUserId,
        //                            CreationTime = a.CreationTime,
        //                            StatusId = a.StatusId ?? 0,
        //                            StatusColorCode = a.EnqStatus.EnqStatusColor,
        //                            StatusName = a.EnqStatus.EnqStatusName ?? "",
        ...
        //                            TeamId = enqDetail.TeamId ?? 0,
        //                            TeamName = enqDetail.TeamId != null ? enqDetail.Team.Name : "",
        //                            Approved = enqDetail.Companys.IsApproved,
        //                            SalesMan = enqDetail.AbpAccountManager.UserName ?? "",
        //                            EstimationValueformat = enqDetail.EstimationValue.ToString("N", new CultureInfo("en-US")).TrimEnd('0').TrimEnd('.'),
        //                            ClosureDate = enqDetail.ClosureDate,
        //                            LastActivity = enqDetail.LastActivity,
        //                            IsExpire = false,
        //                            EstimationValue = (int)enqDetail.EstimationValue,
        //                            ProfilePicture = ur.ProfilePictureId != null ? "" : null,
        //                            UserName = ur.UserName,
        //                            AssignedbyImage = "/assets/common/images/default-profile-picture.png",
        //                            DesignerImage = "/assets/common/images/default-profile-picture.png"
        //                        }).ToList();
        ...
        //            var data = _LeadDetailRepository.GetAll().Where(c => c.InquiryId == d.Id).Select(s => s.EstimationValue).FirstOrDefault();
        //            if (data != null)
        //            {
        //                d.EstimationValue = (int)data;
        //                d.EstimationValueformat = d.EstimationValue.ToString("N", new CultureInfo("en-US")).TrimEnd('0').TrimEnd('.');
        //            }
        ...
        //            {
        //                byte[] bytes = new byte[0];
        //                var Account = (from c in UserManager.Users where c.Id == (long)d.AssignedbyId select c).FirstOrDefault();
        //                d.SalesMan = Account.UserName;
        //                d.AssignedbyImage = "Common/Profile/default-profile-picture.png";
        //                if (Account.ProfilePictureUrl != null)
        //                {
        //                    d.AssignedbyImage = Account.ProfilePictureUrl;
        //                }
        //            }
        ...
        //                    var profilePictureId = Account.ProfilePictureId;
        //                    d.DesignerImage = "Common/Profile/default-profile-picture.png";
        //                    if (Account.ProfilePictureUrl != null)
        //                    {
        //                        d.DesignerImage = Account.ProfilePictureUrl;
        //                    }
        //                }
        //            }

        //            d.Quotations = (from r in _quotationRepository.GetAll().Where(p => p.Revised == false)
        //                            where r.InquiryId == d.Id && r.MileStoneId < 6 && r.Revised != true && r.IsClosed != true && r.Archieved != true && r.Void != true
        //                            select
        //                            new QuotationLists
        //                            {
        //                                QuotationName = r.RefNo,
        //                                IsOptional = r.Optional
        //                            }).ToArray();

        //            d.QuotationCount = (from r in _quotationRepository.GetAll().Where(p => p.Revised == false)
        //                                where r.InquiryId == d.Id && r.Revised != true && r.IsClosed != true && r.Archieved != true && r.Void != true
        //                                select r).Count();


        //            if (d.QuotationCount > 0)
        //            {
        //                var MaxMileStonesId = (from r in _quotationRepository.GetAll() where r.InquiryId == d.Id select r).Max(c => c.MileStoneId);
        //                var fvalue = (from r in _quotationRepository.GetAll() where r.InquiryId == d.Id && r.Revised != true && r.IsClosed != true && r.Archieved != true && r.Void != true && r.Total > 0 && r.MileStoneId == MaxMileStonesId select r).Min(a => a.Negotiation == true ? a.Total - a.OverAllDiscountAmount : a.Total);
        //                if (fvalue > 0)
        //                {
        //                    d.EstimationValue = fvalue;
        //                    d.EstimationValueformat = d.EstimationValue.ToString("N", new CultureInfo("en-US")).TrimEnd('0').TrimEnd('.');
        //                }
        ...
        //            // var WonQuotationcount = (from r in _quotationRepository.GetAll()
        //            //                          where r.InquiryId == d.Id && r.QuotationStatusId == 4 && r.Revised != true && r.IsClosed != true && r.Archieved != true && r.Void != true
        //            //                          select r).Count();

        //            // d.Archieved = WonQuotationcount > 0 ? true : false;

        //            // var NewQuotationcount = (from r in _quotationRepository.GetAll()
        //            //                          where r.InquiryId == d.Id && r.QuotationStatusId == 1 && r.Revised != true && r.IsClosed != true && r.Archieved != true && r.Void != true
        //            //                          select r).Count();

        //            //d.IsClosed = (d.QuotationCount == NewQuotationcount && d.QuotationCount > 0) ? true : false;
        ...
        //    List<IEnumerable<InquiryListDto>> resultdata = new List<IEnumerable<InquiryListDto>>();
        ...
        //        if (newsts.Id == 5)
        //        {
        //            var TotValue = (from r in NewStatuss where r.MileStoneId == newsts.Id && (r.Quotations.Length > 0 || r.QuotationCount == 0) select r).Sum(p => p.EstimationValue);
        //            SubListout.Add(new TickectRegistrationOutput
        //            {
        //                Name = newsts.MileStoneName,
        //                StatusId = newsts.Id,
        ...
        //                IsQuotation = false,
        //                Class = "enquiryclass",
        //                GetTicketReservation = (from r in NewStatuss where r.MileStoneId == newsts.Id && (r.Quotations.Length > 0 || r.QuotationCount == 0) select r).OrderByDescending(p => p.CreationTime).ToArray()
        //            });
        //        }
        //        else
        //        {
        ...
        //    var QSupportMileStonesId = (from r in _milestoneRepository.GetAll() where r.Id > 3 && r.IsQuotation == true select r).Min(c => c.Id);

        //    var Quotationquery = _quotationRepository.GetAll().Where(p => p.Id == 0);

        //    if (userrole.DisplayName == "Sales Executive")
        //    {
        //        Quotationquery = (from q in _quotationRepository.GetAll()
        //                          where q.Revised != true && q.IsClosed != true && q.Archieved != true && q.Void != true && q.SalesPersonId == userid
        //                          select q
        //                );
        //    }
        //    else if (userrole.DisplayName == "Sales Manager" || userrole.DisplayName == "Sales Manager / Sales Executive")
        ...
        //                          join team in _TeamRepository.GetAll() on enqDetail.TeamId equals team.Id
        //                          join usr in UserManager.Users on team.SalesManagerId equals usr.Id
        //                          where q.Revised != true && q.IsClosed != true && q.Archieved != true && q.Void != true && team.SalesManagerId == userid
        //                          select q
        //                );
        //    }
        //    else if (userrole.DisplayName == "Designer")
        ...
        //                          join enq in _inquiryRepository.GetAll() on q.InquiryId equals enq.Id
        //                          join leadDetail in _LeadDetailRepository.GetAll() on enq.Id equals leadDetail.InquiryId
        //                          where q.Revised != true && q.IsClosed != true && q.Archieved != true && q.Void != true && leadDetail.DesignerId == userid
        //                          select q
        //                );
        //    }
        //    else if (userrole.DisplayName == "Sales Coordinator")
        ...
        //                          join enq in _inquiryRepository.GetAll() on q.InquiryId equals enq.Id
        //                          join leadDetail in _LeadDetailRepository.GetAll() on enq.Id equals leadDetail.InquiryId
        //                          where q.Revised != true && q.IsClosed != true && q.Archieved != true && q.Void != true && leadDetail.CoordinatorId == userid
        //                          select q
        //                );
        //    }
        //    else
        //    {
        //        Quotationquery = _quotationRepository.GetAll().Where(p => p.Revised == false && p.IsClosed != true && p.Archieved != true && p.Void != true);

        //    }
        //    Quotationquery = Quotationquery
        //                       .WhereIf(
        //                            !input.Filter.IsNullOrEmpty(),
        //                            p => p.NewCompanys.Name.Contains(input.Filter) ||
        //                                 p.RefNo.Contains(input.Filter) ||
        //                                 p.Inquiry.Name.Contains(input.Filter) ||
        //                                 p.Inquiry.SubMmissionId.Contains(input.Filter));

        //    var NewQuotationStatus = (from a in Quotationquery
        //                              where a.MileStoneId >= QSupportMileStonesId
        //                              select new InquiryListDto
        //                              {
        //                                  Id = a.InquiryId ?? 0,
        //                                  MileStoneId = a.MileStoneId,
        ...
        //                                  StatusName = a.EnqStatus.EnqStatusName ?? "",
        //                                  Percentage = (int)(a.EnqStatus.Percentage ?? 0),
        //                                  SalesMan = a.SalesPerson.UserName ?? "",
        //                                  AssignedbyId = a.SalesPersonId,
        //                                  Name = a.RefNo,
        //                                  Address = a.Inquiry.Locations.LocationName ?? "",
        //                                  WebSite = "",
        //                                  Email = "",
        //                                  MbNo = "",
        //                                  Remarks = "",
        ...
        //                                  CreationTime = a.CreationTime,
        //                                  DepartmentId = 0,
        //                                  DepartmentName = "quotation",
        //                                  StatusId = a.StageId,
        //                                  StatusColorCode = "#d6d6d6",
        //                                  QuotationId = a.Id,
        //                                  QuotationCount = a.VatAmount,
        //                                  IsOptional = a.Optional,
        //                                  InquiryName = a.Inquiry.Name,
        //                                  Approved = true,
        //                                  IsEditable = a.StageId > 11 ? false : true,
        //                                  EstimationValue = a.IsVat == true ? (a.Negotiation == true ? a.Total - a.OverAllDiscountAmount : a.Total) + a.VatAmount : a.Negotiation == true ? a.Total - a.OverAllDiscountAmount : a.Total,
        //                                  EstimationValueformat = ((int)a.Total).ToString("N", new CultureInfo("en-US")).TrimEnd('0').TrimEnd('.'),
        //                                  AssignedbyImage = "Common/Profile/default-profile-picture.png",
        //                                  DesignerImage = "Common/Profile/default-profile-picture.png",

        //                              }).ToList().OrderBy(a => a.Id);



        //    foreach (var t in NewQuotationStatus)
        //    {
        //        t.EstimationValueformat = ((int)t.EstimationValue).ToString("N", new CultureInfo("en-US")).TrimEnd('0').TrimEnd('.');

        //        if (t.AssignedbyId > 0)
        //        {
        //            var Account = (from c in UserManager.Users where c.Id == (long)t.AssignedbyId select c).FirstOrDefault();
        //            t.SalesMan = Account.UserName;
        //            if (Account.ProfilePictureUrl != null)
        //            {

        //                t.AssignedbyImage = Account.ProfilePictureUrl;
        //            }
        //        }

        //        var leadDetail = _LeadDetailRepository.GetAll().Where(p => p.InquiryId == t.Id).FirstOrDefault();
        //        if (leadDetail != null)
        //        {
        //            if (leadDetail.DesignerId > 0)
        //            {
        ...
        //                var Account = (from c in UserManager.Users where c.Id == (long)leadDetail.DesignerId select c).FirstOrDefault();
        //                t.DesignerName = Account.UserName;
        //                if (Account.ProfilePictureUrl != null)
        //                {
        //                    t.DesignerImage = Account.ProfilePictureUrl;
        //                }
        //            }
        //        }
        //    }
        ...
        //    {
        //        var TotValue = (from r in NewQuotationStatus where r.MileStoneId == Qnewsts.Id select r).Sum(p => p.EstimationValue);
        //        SubListout.Add(new TickectRegistrationOutput
        //        {
        ...
        //            GetTicketReservation = (from r in NewQuotationStatus where r.MileStoneId == Qnewsts.Id select r).OrderByDescending(p => p.CreationTime).ToArray()
        //        });
        //    }
