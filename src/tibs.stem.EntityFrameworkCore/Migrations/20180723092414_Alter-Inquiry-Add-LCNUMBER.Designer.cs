...
namespace tibs.stem.Migrations
{
    ...
    [Migration("20180723092414_Alter-Inquiry-Add-LCNUMBER")]
    partial class AlterInquiryAddLCNUMBER
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("tibs.stem.ColorGraphs.ColorGraph", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("tibs.stem.Finish.Finished", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("tibs.stem.Finish.FinishedDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("tibs.stem.Inquirys.Inquiry", b =>
                {
                    ...
                    b.Property<string>("CLandlineNumber");

                    b.Property<string>("CMbNo");
                    ...
                    b.Property<bool>("DesignerApproval");

                    b.Property<bool>("DisableQuotation");
                    ...
                    b.Property<bool>("RevisionApproval");
            ...
            modelBuilder.Entity("tibs.stem.LeadStatuss.LeadStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("LeadStatusCode");
            ...
            modelBuilder.Entity("tibs.stem.Products.ProductStates", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("tibs.stem.Quotations.Quotation", b =>
                {
                    ...
                    b.Property<int>("OverAllDiscountAmount");

                    b.Property<int>("OverAllDiscountPercentage");
            ...
            modelBuilder.Entity("tibs.stem.UserDesignations.UserDesignation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("tibs.stem.Views.DateFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("DateFilter");
                });

            modelBuilder.Entity("tibs.stem.Views.ReportColumn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("tibs.stem.Views.View", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<long?>("AllPersonId");

                    b.Property<string>("Categories");

                    b.Property<string>("ClosureDate");

                    b.Property<int?>("ClosureDateFilterId");
                    ...
                    b.Property<int?>("GraterAmount");

                    b.Property<string>("InquiryCreateBy");

                    b.Property<string>("InquiryCreation");
                    ...
                    b.Property<int?>("LastActivityDateFilterId");

                    b.Property<DateTime?>("LastModificationTime");

                    b.Property<long?>("LastModifierUserId");

                    b.Property<int?>("LessAmount");
                    ...
                    b.Property<string>("QuotationCreateBy");

                    b.Property<string>("QuotationCreation");
                    ...
                    b.Property<string>("StatusForQuotation");

                    b.Property<string>("TeamName");

                    b.Property<string>("UserIds");

                    b.Property<string>("WhyBafco");

                    b.HasKey("Id");

                    b.HasIndex("AllPersonId");

                    b.HasIndex("ClosureDateFilterId");

                    b.HasIndex("DateFilterId");

                    b.HasIndex("LastActivityDateFilterId");
            ...
            modelBuilder.Entity("tibs.stem.Authorization.Users.User", b =>
                {
                    ...
                    b.HasOne("tibs.stem.UserDesignations.UserDesignation", "UserDesignations")
                        .WithMany()
                        .HasForeignKey("UserDesignationId");
                });
            ...
            modelBuilder.Entity("tibs.stem.Finish.FinishedDetail", b =>
                {
                    b.HasOne("tibs.stem.Finish.Finished", "Finishedd")
                        .WithMany()
            ...
            modelBuilder.Entity("tibs.stem.Inquirys.Inquiry", b =>
                {
                    ...
                    b.HasOne("tibs.stem.LeadStatuss.LeadStatus", "LeadStatuss")
                        .WithMany()
            ...
            modelBuilder.Entity("tibs.stem.Products.Product", b =>
                {
                    ...
                    b.HasOne("tibs.stem.Products.ProductStates", "ProductState")
                        .WithMany()
            ...
            modelBuilder.Entity("tibs.stem.Views.View", b =>
                {
                    b.HasOne("tibs.stem.Authorization.Users.User", "AllPerson")
                        .WithMany()
                        .HasForeignKey("AllPersonId");

                    b.HasOne("tibs.stem.Views.DateFilter", "ClsDateFilters")
                        .WithMany()
                        .HasForeignKey("ClosureDateFilterId");

                    b.HasOne("tibs.stem.Views.DateFilter", "DateFilters")
                        .WithMany()
                        .HasForeignKey("DateFilterId");

                    b.HasOne("tibs.stem.Views.DateFilter", "LADateFilters")
                        .WithMany()
                        .HasForeignKey("LastActivityDateFilterId");
