...
namespace tibs.stem.Migrations
{
    ...
    [Migration("20170908072729_add-ProductFamilys-table")]
    partial class addProductFamilystable
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("tibs.stem.ProductAttributeGroups.ProductAttributeGroup", b =>
                {
                    b.HasOne("tibs.stem.ProductAttributes.ProductAttribute", "productAttributes")
                        .WithMany()
